                ...
                <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                            ...
                            <div class="block w-full col-span-3 p-6 pb-8 mb-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                ...
                                <div class="grid grid-cols-1 col-span-3 gap-4  border min-[1150px]:grid-cols-5 border-gray-200 p-4" >
                                    <div class="grid col-span-3 gap-4 sm:grid-cols-1 min-[900px]:grid-cols-3">
                                        <div>
                                            <label for="coreFunctions[{{$index}}][output]"
                                        ...
                                        <div>
                                            <label for="coreFunctions[{{$index}}][indicator]"
                                        ...
                                        <div>
                                            <label for="coreFunctions[{{$index}}][accomp]"
                                            ...
                                            <div class="flex-wrap pb-5 ">
                                               ...
                                               <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div class="w-full">
                                                        ...
                                                        <select id="smtpQ" name="coreFunctions[{{$index}}][Q]" wire:model.live="coreFunctions.{{$index}}.Q"
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <select id="smtpE" name="coreFunctions[{{$index}}][E]" wire:model.live="coreFunctions.{{$index}}.E"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                            <option selected>Pick</option>
                                                            <option value="5">5</option>
                                                            <option value="4">4</option>
                                                    ...
                                                    <div class="w-full ">
                                                        ...
                                                        <select id="smtpT" name="coreFunctions[{{$index}}][T]" wire:model.live="coreFunctions.{{$index}}.T"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                            <option selected>Pick</option>
                                                            <option value="5">5</option>
                                                            <option value="4">4</option>
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <select id="smtpA" name="coreFunctions[{{$index}}][A]" wire:model.live="coreFunctions.{{$index}}.A"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                            <option selected>Pick</option>
                                                            <option value="5">5</option>
                                                            <option value="4">4</option>
                    ...
                    @endforeach
                        ...
                        <div class="block sm:w-1/2 md:w-1/3 min-[900px]:w-1/4 min-[1150px]:w-1/5 mt-4 col-span-1 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                            ...
                            <input type="number" id="core_rating" wire:model.live="core_rating" placeholder="{{$core_rating}}"
                                ...
                                <div class="grid grid-cols-1 col-span-3 gap-4  border min-[1150px]:grid-cols-5 border-gray-200 p-4" >
                                    ...
                                    <div  class="grid grid-cols-1 md:grid-cols-2 gap-4 col-span-3 min-[1150px]:col-span-5">
                                        <div>
                                            <label for="message"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Weight <span class="text-red-600">*</span></label>
                                            <input type="text" name="supportiveFunctions[{{$index}}][weigth]" wire:model="supportiveFunctions.{{$index}}.weight"   class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div>
                                            <label for="message"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Remarks <span class="text-red-600">*</span></label>
