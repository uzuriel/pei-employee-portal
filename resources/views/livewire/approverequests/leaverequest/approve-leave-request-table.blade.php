        ...
        <div class="p-4 rounded-lg dark:border-gray-700">
            <nav class="flex mb-4" aria-label="Breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{route('ApproveLeaveRequestTable')}}" class="ms-1 text-sm font-semibold text-gray-900 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Approve Leave Request</a>
                    </div>
                </li>
