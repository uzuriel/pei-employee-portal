<div>
    ...
    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Approve OPCR</h2>
        ...
        <div class=" px-1 mx-auto  py-8">
            <form wire:submit.prevent="submit" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 col-span-3">
                            <div class="block grid-row-2 w-full min-[0px]:col-span-2  lg:col-span-1  p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                ...
                                <div class="w-full pb-4 pt-4">
                                    ...
                                    <input type="date" value="{{$date_of_filling}}" 
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                ...
                                <div class="w-full">
                                    ...
                                    <input type="text" name="ratee" id="ratee" value="{{$ratee}}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2  gap-4">
                                    <div class="w-full">
                                        ...
                                        <input type="date" name="start_period" id="start_period" value="{{$start_period}}" value="{{$employeeRecordDate}}"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                             required="" disabled>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input type="date" name="endperiod" id="endperiod" value="{{$end_period}}" 
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                           required="" disabled>
                                        @error('end_period')   
                                                ...
                                                <div class="flex-wrap pb-5 ">
                                                   ...
                                                   <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div class="w-full">
                                                            <label
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Q<span class="text-red-600">*</span></label>
                                                            <select disabled id="supportiveFunctions_{{$index}}_Q" wire:model.change="supportiveFunctions.{{$index}}.Q"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                <option selected >Pick</option>
                                                                <option value="5">5</option>
                                                                <option value="4">4</option>
                                                        ...
                                                        <div class="w-full">
                                                            <label
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">E<span class="text-red-600">*</span></label>
                                                            <select disabled id="supportiveFunctions_{{$index}}_E" wire:model.change="supportiveFunctions.{{$index}}.E"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                <option selected>Pick</option>
                                                                <option value="5">5</option>
                                                                <option value="4">4</option>
                                                        ...
                                                        <div class="w-full ">
                                                            <label
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">T<span class="text-red-600">*</span></label>
                                                            <select disabled id="supportiveFunctions[{{$index}}][T]" wire:model.change="supportiveFunctions.{{$index}}.T"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                <option selected>Pick</option>
                                                                <option value="5">5</option>
                                                                <option value="4">4</option>
                                                        ...
                                                        <div class="w-full">
                                                            <label
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">A<span class="text-red-600">*</span></label>
                                                            <select disabled id="supportiveFunctions_{{$index}}_A" wire:model.change="supportiveFunctions.{{$index}}.A"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                                <option selected>Pick</option>
                                                                <option value="5">5</option>
                                                                <option value="4">4</option>
                    ...
                    <div class=" bg-gray-100 p-6 border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                        <div class=" mb-4">
