                                    ...
                                    <td class="items-center text-center py-4">
                                            ...
                                            <div class="hidden  top-0 right-0 mt-2 z-50 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                ...
                                                {{-- <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"> --}}
                                                    {{-- @if (is_null($it_ticket->leave_form))                                                            
                                                        <li>
                                                            <a onclick="location.href='{{ route('ItHelpDeskUpdate', ['index' => $it_ticket->form_id]) }}'"  class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                        </li>
                                                    @endif
                                                    @if ($it_ticket->leave_form)    
                                                        <li>
                                                            <a target="_blank" href="{{route('downloadLeave', [ 'index' => $it_ticket->form_id])}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">PDF</a>
                                                        </li>
                                                    @endif --}}

                                                {{-- </ul> --}}
                                                <div class="py-2">
                                                    <a wire:click="removeForm('{{$it_ticket->form_id}}')" wire:confirm="Are you sure you want to cancel this concern?" class="block px-4 py-2 cursor-pointer text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Cancel</a>
                                                </div>
                                            </div>
                                        </td>
