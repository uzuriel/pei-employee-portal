    ...
    <div class="p-4 rounded-lg dark:border-gray-700">
        <nav class="flex mb-4" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{route('HrTicketsTable')}}" class="ms-1 text-sm font-semibold text-gray-900 hover:text-customRed md:ms-2 dark:text-gray-400 dark:hover:text-white">Hr Tickets</a>
                </div>
            </li>
            </ol>
        </nav>
        ...
        {{-- <div class="grid grid-cols-1 min-[902px]:grid-cols-2 gap-4 w-full min-[450px]:w-1/3  lg:w-1/3">
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p class="font-semibold text-3xl text-red-600 dark:text-gray-400">{{$vacationCredits ?? 0.00}}</p>
            </div>
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p class="font-semibold text-3xl text-red-600 dark:text-gray-400">{{$sickCredits ?? 0.00}}</p>
            </div>
        </div> --}}
        ...
        <div class="shadow-md overflow-x-auto rounded-t-lg  bg-white pb-4 w-full" >
            <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4 p-4">
                <div>
                    {{-- Date Filter --}}
                    <button id="dropdownRadioButton" data-dropdown-toggle="dateDropDown" class=" z-50 inline-flex items-center ring-1 ring-gray-900 h-10 p-2 hover:bg-gray-100 focus:ring-1 focus:border-1 focus:ring-customRed focus:border-customRed font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                    ...
                    <div id="dateDropDown" class="hidden mt-2 z-50 w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(522.5px, 3847.5px, 0px);">
                        <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded text-gray-900 hover:bg-customRed hover:text-white dark:hover:bg-gray-600">
                                    <input id="date_filter-radio-example-1" type="radio" wire:model.live="date_filter" value="1" name="date_filter-radio" class="w-4 h-4 text-customRed bg-gray-100 ring-2 ring-white hover border-gray-300 focus:ring-customRed dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">  &nbsp; Last day </input>
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded text-gray-900 hover:bg-customRed hover:text-white dark:hover:bg-gray-600">
                                    <input id="date_filter-radio-example-4" type="radio" wire:model.live="date_filter" value="4" name="date_filter-radio" class="w-4 h-4 text-customRed bg-gray-100 ring-2 ring-white border-gray-300 focus:ring-customRed dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">  &nbsp; Last 6 Monthss </input>
                    ...
                    {{-- Status Filter --}}
                    <button id="dropdownRadioButton" data-dropdown-toggle="statusDropDown" class=" z-50 inline-flex items-center text-gray-900 bg-white border h-10  border-gray-900  focus:outline-none hover:bg-gray-100 focus:ring-1 focus:ring-customRed font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                        <svg class="w-3 h-3 text-gray-900 dark:text-gray-400 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm3.982 13.982a1 1 0 0 1-1.414 0l-3.274-3.274A1.012 1.012 0 0 1 9 10V6a1 1 0 0 1 2 0v3.586l2.982 2.982a1 1 0 0 1 0 1.414Z"/>
                            </svg>
                        {{$statusFilterName}}
                    ...
                    <div id="statusDropDown" class="hidden mt-2 z-50 w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top" style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(522.5px, 3847.5px, 0px);">
                        <ul class="p-3 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                            <li>
                                <div class="flex items-center p-2 rounded text-gray-900 cursor-pointer   dark:hover:bg-gray-600">
                                    <input id="status_filter-radio-example-1" type="radio" wire:model.live="status_filter" value="0" name="status_filter-radio" class="w-4 h-4 cursor-pointer text-gray-600 bg-gray-100 border-gray-300 focus:ring-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"> &nbsp; All </input>
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded text-gray-900 hover:bg-green-800 hover:text-white cursor-pointer dark:hover:bg-gray-600">
                                    <input id="status_filter-radio-example-1" type="radio" wire:model.live="status_filter" value="1" name="status_filter-radio" class="w-4 h-4  cursor-pointer text-green-800 bg-gray-100 ring-2 ring-white border-gray-300 focus:ring-green-800 focus:bg-green-800 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"> &nbsp; Approved </input>
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded text-gray-900 hover:bg-amber-800  hover:text-white cursor-pointer dark:hover:bg-gray-600">
                                    <input checked="" id="status_filter-radio-example-2" type="radio" wire:model.live="status_filter" value="2" name="status_filter-radio" class="w-4 h-4 cursor-pointer text-amber-800  bg-gray-100 ring-2 ring-white border-gray-300 focus:ring-amber-800  dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"> &nbsp; Pending </input>
                            ...
                            <li>
                                <div class="flex items-center p-2 rounded text-gray-900 hover:bg-customRed hover:text-white cursor-pointer dark:hover:bg-gray-600">
                                    <input id="status_filter-radio-example-3" type="radio" wire:model.live="status_filter" value="3" name="status_filter-radio" class="w-4 h-4 cursor-pointer text-customRed bg-gray-100 ring-2 ring-white border-gray-300 focus:ring-customRed dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"> &nbsp; Declined </input>
                        ...
                        @else
                            ...
                            @endphp
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    {{-- <a onclick="location.href='{{ route('ipcredit', ['index' => $hrticket->id]) }}'"  class="cursor-pointer font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                        {{-- <a href="{{route('ipcredit', $hrticket)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                        {{-- <a wire:click="removeIpcr({{$hrticket->id}})" class="cursor-pointer font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Remove</a> --}}
                                    ...
                                    <td class="items-center text-center py-4">
                                            ...
                                            <div class="hidden  top-0 right-0 mt-2 z-50 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                ...
                                                {{-- <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                    ...
                                                    @endif
                                                    @if ($hrticket->leave_form)    
                                                        <li>
                                                            <a target="_blank" href="{{route('downloadLeave', [ 'index' => $hrticket->form_id])}}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">PDF</a>
                                                        </li>
                                                    @endif
                                                </ul> --}}
                                                <div class="py-2">
                                                    <a wire:click="removeLeaveRequest('{{$hrticket->form_id}}')" wire:confirm="Are you sure you want to cancel this ticket?" class="block px-4 py-2 cursor-pointer text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Cancel</a>
                                                </div>
                                            </div>
                                    </td>
                                        ...
                                        {{-- <td class="items-center px-6 py-4">
                                            ...
                                            <div class="hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                    <li>
                                                        <a onclick="location.href='{{ route('LeaveRequestEdit', ['index' => $hrticket->id]) }}'"  class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                    </li>
                                                    <li>
                                                        <a onclick="location.href='{{ route('LeaveRequestPdf', ['index' => $hrticket->id]) }}'" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">PDF</a>
                                                    </li>
                                                </ul>
                                                <div class="py-2">
                                                    <a wire:click="removeLeaveRequest({{$hrticket->id}})" wire:confirm="Are you sure you want to delete this post?" class="block px-4 py-2 text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Delete</a>
                                                </div>
                                            </div>
                                        </td> --}}
                                </tr>
