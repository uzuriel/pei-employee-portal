<div>
    ...
    <section class="bg-white  dark:bg-gray-900 pb-24 px-8  rounded-lg">
        ...
        <div class=" px-1 mx-auto pt-8">
            ...
            <div class="grid grid-cols-1 gap-4  p-6 mt-5 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                <h2><b>Pre Test</b></h2>
                @foreach ($postTest as $index => $preQuestion)   
                    <div class="w-full col-span-3 ">
                        ...
                        <div class="grid grid-cols-2 gap-4 w-full col-span-3 p-6 pb-8 mb-4 bg-white border border-gray-200  shadow  dark:bg-gray-800 dark:border-gray-700 ">
                            <div>
                                ...
                                <textarea disabled type="text" id="postTest_{{$index}}_question" wire:model.blur="postTest.{{$index}}.question" class="block p-2.5 w-full font-bold bg-gray-200 text-sm text-gray-900 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </textarea>
                            </div>
                            <div>
