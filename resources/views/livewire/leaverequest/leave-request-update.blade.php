<div>
    ...
    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Update Leave Request</h2>
    <section class="bg-white dark:bg-gray-900 pb-24 px-8 mt-10 rounded-lg">
        <div class=" px-1 mx-auto pt-8">
            <form wire:submit.prevent="submit" method="POST">
                ...
                <button type="submit"  class="inline-flex items-center float-right px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-customRed border-2 border-customRed hover:bg-customRed focus:text-white focus:bg-customRed hover:text-white bg-white rounded-lg focus:ring-4 focus:ring-customRed dark:focus:ring-primary-900 hover:bg-primary-800">
