<div class="main-content">
    <div class="p-4 rounded-lg dark:border-gray-700">
        ...
        <div class="flex justify-end">
            <button type="button" onclick="location.href='{{ route('TasksTable') }}'" class="text-customRed mb-8 ring-1 ring-customRed bg-white hover:bg-customRed hover:text-white focus:ring-4 focus:ring-customRed font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Assign a Task</button>
        </div>
                                            ...
                                            <div class="hidden  top-0 right-0 mt-2 z-50 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                ...
                                                {{-- <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"> --}}
                                                    @if (is_null($my_task->leave_form))                                                            
                                                        <li>
                                                            <a onclick="location.href='{{ route('TasksUpdate', ['index' => $my_task->form_id]) }}'"  class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                        </li>
                                                    @endif
