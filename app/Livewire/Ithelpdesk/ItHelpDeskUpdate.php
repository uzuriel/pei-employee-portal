...
class ItHelpDeskUpdate extends Component
{
    ...
    public function submit(){
        ...
        $it_ticket =  Ittickets::findOrFail($this->index);

        $it_ticket->employee_id = $loggedInUser->employee_id;
        $it_ticket->status = "Pending";
        $it_ticket->description = $this->description;
        $it_ticket->update();

        $this->js("alert('Concern Updated!')"); 
    ...
    {
        return view('livewire.ithelpdesk.it-help-desk-update')->extends('components.layouts.app');
    }
